...
{start}
  ...
  Welcome to this minimal demo of org-index {sleepscale 0.2}{sleep 0.5}!
  {sleep 1}
...
* one four
  ...
  some questions and create your index. Just watch ... {sleep 1}{sleepscale 0.4}{sleep 1}{kbd M-x~o~r~g~-~i~n~d~e~x~RET~c~r~e~a~t~e~-~i~n~d~e~x~10~RET~10~d~e~m~o~.~o~r~g~10~RET~I~n~d~e~x~10~RET~-~-~\1~-~-~10~RET~y~10~RET~y~10~RET~C~-~c~SPC~i~10~RET~y~10~RET}done.{sleep 1}
{return}
