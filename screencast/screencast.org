...
* one four
  ...
  its ID. Note also, how the index table grows ...{#dosleep}{mark}{search * one two}{kbd C-a C-c i a~4~RET TAB}{sleep 0.3}{search * one three}{kbd C-a C-c i a~4~RET TAB}{sleep 0.3}{search * two three}{kbd C-a C-c i a~4~RET TAB}{sleep 0.3}{search * one four}{kbd C-a C-c i a~4~TAB}{sleep 0.3}{return} done.{sleep 1}
